...
.. changelog::
    ...
    .. change::
        ...
        **Date**: 2025-06-03
        ...
        Description:
        For ducted HVAC system upgrades, adds the ability to limit the autosized capacity based on the existing duct system, and adjust the blower fan efficiency to maintain the duct system curve.
