...
For options and properties that vary across heat pump and other heating system options, see Table \ref{table:hc_opt_hvac_heating_efficiency}. The \texttt{heating\_system\_type} argument is none, \texttt{heating\_system\_heating\_efficiency} is 0 and not used. The \texttt{heat\_pump\_backup\_type} is set to integrated. The \texttt{heating\_system\_pilot\_light} argument is not specified.
