...
\hypersetup{colorlinks=true, urlcolor=nlrblue}
% -----------------------------------
% DOCUMENT PROPERTIES
% -----------------------------------
...
In 2024-25, The ResStock Data Viewer for the public data was accessed across all 50 U.S. states, by more than 2,000 unique users who queried the data on average 16 times per user. The queries mainly support consultants, utilities, city, county, and local governments, state offices, DOE, and other federal offices. It is estimated that the datasets that ResStock produces are used by utilities that deliver over half of all US electric sales. The combined ResStock and ComStock datasets contributed to over \$2 billion dollars worth of industry project revenue. Cumulatively, the datasets have been downloaded over 45 million times, making it the most downloaded dataset across the Open Energy Data Initiative's (OEDI) 2,976 datasets.
...
This work was authored by the National Laboratory of the Rockies, operated by Alliance for Energy Innovation, LLC, for the U.S. Department of Energy (DOE) under Contract No. DE-AC36-08GO28308. Funding provided by U.S. Department of Energy Office of Critical Minerals and Energy Innovation. The views expressed in the article do not necessarily represent the views of the DOE or the U.S. Government.

A portion of this research was performed using computational resources sponsored by the U.S. Department of Energy's Office of Critical Minerals and Energy Innovation and located at the National Laboratory of the Rockies.
...
\begin{tabular}{ |c || c c|}
\hline
    Technical Reference Documentation & Standard Data Release & ResStock \\ \hline \hline
Draft, ResStock 2025 Release 1, October 2025 & \href{https://resstock.nrel.gov/datasets}{2025 Release 1} &
\href{https://github.com/NREL/resstock/releases/tag/2025_Release_1}{\texttt{sdr\_2025\_Release\_1}} \\\hline
v3.3.0, July 2025 & \href{https://resstock.nrel.gov/datasets}{2024.2} &
\href{https://github.com/NREL/resstock/tree/v3.3.0}{v3.3.0} \\\hline
\end{tabular}
\end{center}
...
\begin{tabular}{ |c || c c|}
\hline
    Technical Reference Documentation & BuildStock Batch  & OpenStudio-HPXML \\ \hline \hline
Draft, ResStock 2025 Release 1, October 2025 & \href{https://github.com/NREL/buildstockbatch/releases/tag/ResStock_SDR_2025_Release_1}{ResStock SDR 2025 Release 1} &
\href{https://github.com/NREL/OpenStudio-HPXML/releases/tag/v1.10.0}{v1.10.0} \\\hline
v3.3.0, July 2025 & \href{https://github.com/NREL/buildstockbatch/tree/v2023.10.0}{v2023.10.0} &
\href{https://github.com/NREL/OpenStudio-HPXML/tree/v1.8.1}{v1.8.1} \\\hline
\end{tabular}
\end{center}
...
\acro {SUV}{sport utility vehicle}
