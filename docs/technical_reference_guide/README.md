...
Note that currently the "Description", "Distribution Data Sources", and "Distribution Assumption" subsections are not automatically generated by their corresponding `.tex` files.
