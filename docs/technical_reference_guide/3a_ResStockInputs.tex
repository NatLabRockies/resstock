...
\paragraph{Options}
The County characteristic options are structured using the State name and County name. An example of the option corresponding to Denver County in Colorado would be ``CO, Denver County''. Each option sets the following properties.

The \texttt{location\_zip\_code} property is assigned by using a single zip code for the entire county.

The \texttt{location\_epw\_filepath} property is ``../../../weather/<County GISJOIN>.epw'' where <County GISJOIN> is the NHGIS GISJOIN value for the county. The NHGISJOIN for a county always starts with the letter ``G'' followed by the state's two-digit FIPS, a ``0,'' and then the County 3-digit FIPS code. An example of this property assignment for the option ``CO, Denver County'' is \texttt{location\_epw\_filepath}=../../../weather/G0800310.epw.
...
The ASHRAE IECC Climate Zone 2004 sets the following properties. The \texttt{site\_iecc\_zone} property matches the climate zone with the exception of climate zones 7 and 8 in Alaska. ResStock departs from the climate zone definitions by using 7AK and 8AK instead of 7 and 8 from the standards.
...
For property definitions, see Table \ref{table:hc_arg_def_orientation}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-building-site}{Building Site} documentation for additional information on defaults and modeling assumptions.
...
For property definitions, see Table \ref{table:hc_arg_def_geometry_stories}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-building-construction}{Building Construction} documentation for additional information on defaults and modeling assumptions.
...
For property definitions, see Table~\ref{table:hc_arg_def_geometry_building_number_units_mf}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#whole-sfa-mf-buildings}{Whole-SFA-MF-Buildings} documentation for additional information on defaults and modeling assumptions.
...
For property definitions, see Table~\ref{table:hc_arg_def_geometry_building_number_units_sfa}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#whole-sfa-mf-buildings}{Whole-SFA-MF-Buildings} documentation for additional information on defaults and modeling assumptions.
...
For property definitions, see Table \ref{table:hc_arg_def_geometry_building_horizontal_location_mf}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-building-construction}{Building Construction} documentation for additional information on defaults and modeling assumptions.
...
For property definitions, see Table \ref{table:hc_arg_def_geometry_building_horizontal_location_sfa}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-building-construction}{Building Construction} documentation for additional information on defaults and modeling assumptions.
...
\end{itemize}
\paragraph{Options}
The options for Neighbors are shown in Table \ref{table:hc_opt_neighbors}. The option values correspond to distances in feet to the nearest neighbor on the left and right sides of the building. The options set ResStock properties corresponding to the distance of shading objects, while the shading object height is assumed to be the same as the housing unit's height. It's also assumed that there are no neighbors to the front and back of the unit. The None option means there are no neighbors.

\input{tables/options/Neighbors}

For property definitions, see Table~\ref{table:hc_arg_def_neighbors}. See the OpenStudio-HPXML documentation section \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-neighbor-buildings}{Neighbor Buildings} for the available elements, default values, and constraints.
...
For property definitions, see Table~\ref{table:hc_arg_def_corridor}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#dwelling-units}{Dwelling Units} documentation for additional information on defaults and modeling assumptions.
...
For the property definitions, see Table~\ref{table:hc_arg_def_geometry_building_type_recs}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-building-construction}{Building Construction} documentation for additional information on defaults and modeling assumptions.
...
For property definitions, see Table \ref{table:hc_arg_def_vintage}.
...
For property definitions, see Table \ref{table:hc_arg_def_geometry_floor_area}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-building-construction}{Building Construction} documentation for additional information on defaults and modeling assumptions. The floor area is used many places in the OpenStudio-HPXML model workflow.
...
For property definitions, see Table \ref{table:hc_arg_def_bedrooms}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-building-construction}{Building Construction} documentation for additional information on defaults and modeling assumptions. The number of bedrooms is used many places in the OpenStudio-HPXML model workflow.
...
For property definitions, see Table \ref{table:hc_arg_def_geometry_attic_type}. See OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-attics}{Attics} documentation for additional information on defaults and modeling assumptions.
...
For property definitions, see Table \ref{table:hc_arg_def_geometry_foundation_type}.
...
For property definitions, see Table \ref{table:hc_arg_def_geometry_garage}.
...
For property definitions, see Table \ref{table:hc_arg_def_geometry_wall_exterior_finish}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-walls}{Walls} documentation for additional information on defaults and modeling assumptions.
...
For property definitions, see Table \ref{table:hc_arg_def_insulation_wall}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-walls}{Walls} documentation for additional information on defaults and modeling assumptions.
...
For property definitions, see Table \ref{table:hc_arg_def_insulation_roof}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-roofs}{Roofs} documentation for additional information on defaults and modeling assumptions.
...
For property definitions, see Table \ref{table:hc_arg_def_radiant_barrier}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-roofs}{Roofs} documentation for additional information on defaults and modeling assumptions.
...
For property definitions, see Table \ref{table:hc_arg_def_roof_material}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-roof}{Roof} documentation for additional information on defaults and modeling assumptions.
...
For property definitions, see Table \ref{table:hc_arg_def_insulation_ceiling}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-attics}{Attics} documentation for additional information on defaults and modeling assumptions.
...
For property definitions, see Table \ref{table:hc_arg_def_insulation_floor}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-floors}{Floors} documentation for additional information on defaults and modeling assumptions.
...
For property definitions, see Table \ref{table:hc_arg_def_insulation_slab}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-slabs}{Slabs} documentation for additional information on defaults and modeling assumptions.
...
For property definitions, see Table \ref{table:hc_arg_def_insulation_foundation_wall}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html\#hpxml-foundation-walls}{Foundation Walls} documentation for additional information on defaults and modeling assumptions.
...
For property definitions, see Table \ref{table:hc_arg_def_insulation_rim_joist}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-rim-joists}{Rim Joists} documentation for additional information on defaults and modeling assumptions.
...
For property definitions, see Table \ref{table:hc_arg_def_ground_thermal_conductivity}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html\#hpxml-site}{Site} documentation for additional information on defaults and modeling assumptions.
...
For property definitions, see Table \ref{table:hc_arg_def_door_area}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-doors}{Doors} documentation for additional information on defaults and modeling assumptions.
...
For property definitions, see Table \ref{table:hc_arg_def_doors}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-doors}{Doors} documentation for additional information on defaults and modeling assumptions.
...
For property definitions, see Table \ref{table:hc_arg_def_windows}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-windows}{Windows} documentation for additional information on defaults and modeling assumptions.
...
For property definitions, see Table \ref{table:hc_arg_def_window_areas}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-windows}{Windows} documentation for additional information on defaults and modeling assumptions.
...
For property definitions, see Table \ref{table:hc_arg_def_eaves}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-overhangs}{Overhangs} documentation for additional information on defaults and modeling assumptions.
...
For property definitions, see Table \ref{table:hc_arg_def_interior_shading}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-windows}{Windows} documentation for additional information on defaults and modeling assumptions.
...
For property definitions, see Table \ref{table:hc_arg_def_infiltration}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html##hpxml-air-infiltration}{Air Infiltration} documentation for additional information on defaults and modeling assumptions.
