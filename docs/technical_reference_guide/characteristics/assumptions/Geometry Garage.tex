...
\item Single-family detached units that are 2500-3999 square feet and a heated basement can not have a 3 car garage.
\item Due to low sample sizes,
  \begin{itemize}
  \item Crawl, basements, and slab are lumped.
  \item Story levels are lumped together.
  \item Census Division RECS is grouped into Census Region.
  \item Vintage ACS is progressively grouped into: pre-1960, 1960-1999, and 2000+.
  \end{itemize}
\end{itemize}
