...
This resulted in state average variable electricity rates that ranged from \$0.0938/kWh in Utah to \$0.3965/kWh in Hawaii.
...
\toprule\noalign{}
\textbf{Census Region} & \textbf{Rate \$/month} \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
...
The rates ranged from \$0.76/therm in North Dakota to \$4.84/therm in Hawaii.
...
Alaska prices come from the Alaska Fuel Price Report: Winter 2025(\cite{AK_community_affairs}). The average unsubsidized No. 2 heating fuel price of 93 communities was \$6.58/gallon, and this will be used for the whole state of Alaska. Notable exclusions from the Alaska Fuel Price Report data include Anchorage and Mat-Su. Please read the Alaska Fuel Price report for other relevant assumptions.
