...
\begin{itemize}
        \item \texttt{out.emissions_reduction.<fuel>.<scenario>.co2e\_kg}: The difference in emissions between the baseline and this upgrade.
        ...
        \item \texttt{calc.weighted.emissions_reduction.<fuel>.<scenario>.co2e\_mmt}: The difference in emissions between the baseline and this upgrade, scaled by the weight to represent the national total for this value.
\end{itemize}
