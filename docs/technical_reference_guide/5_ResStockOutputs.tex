...
{\textbf{Field Name} & \textbf{Units} & \textbf{Field Description}}
        ...
        out.electricity.electric\_vehicle\_charging.energy\_consumption.kwh & kWh & Electricity consumed by charging electric vehicles \\ \hline
...
{\textbf{Field Name} & \textbf{Units} & \textbf{Field Description}}
out.emissions.all\_fuels.lrmer\_mid\_case\_25.co2e\_kg & co2e\_kg & Emissions using on-site fossil fuel rates from ANSI/RESNET and electricity using Cambium 2024 mid case scenario with long run marginal emissions rate levelized by 3\% over 25 years \\ \hline
out.emissions.all\_fuels.lrmer\_mid\_case\_15.co2e\_kg & co2e\_kg & Emissions using on-site fossil fuel rates from ANSI/RESNET and electricity using Cambium 2024 mid case scenario with long run marginal emissions rate levelized by 3\% over 15 years starting in 2027 \\ \hline
out.emissions.all\_fuels.lrmer\_high\_re\_cost\_25.co2e\_kg & co2e\_kg & Emissions using on-site fossil fuel rates from ANSI/RESNET and electricity using Cambium 2024 high renewable cost scenario with long run marginal emissions rate levelized by 3\% over 25 years \\ \hline
out.emissions.all\_fuels.lrmer\_high\_re\_cost\_15.co2e\_kg & co2e\_kg & Emissions using on-site fossil fuel rates from ANSI/RESNET and electricity using Cambium 2024 high renewable cost scenario with long run marginal emissions rate levelized by 3\% over 15 years starting in 2027 \\ \hline
out.emissions.all\_fuels.lrmer\_low\_re\_cost\_25.co2e\_kg & co2e\_kg & Emissions using on-site fossil fuel rates from ANSI/RESNET and electricity using Cambium 2024 low renewable cost scenario with long run marginal emissions rate levelized by 3\% over 25 years \\ \hline
out.emissions.all\_fuels.lrmer\_low\_re\_cost\_15.co2e\_kg & co2e\_kg & Emissions using on-site fossil fuel rates from ANSI/RESNET and electricity using Cambium 2024 low renewable cost scenario with long run marginal emissions rate levelized by 3\% over 15 years starting in 2027 \\ \hline
out.emissions.all\_fuels.lrmer\_low\_re\_cost\_high\_ng\_price\_25.co2e\_kg & co2e\_kg & Emissions using on-site fossil fuel rates from ANSI/RESNET and electricity using Cambium 2024 low renewable cost high natural gas price scenario with long run marginal emissions rate levelized by 3\% over 25 years \\ \hline
out.emissions.all\_fuels.lrmer\_low\_re\_cost\_high\_ng\_price\_15.co2e\_kg & co2e\_kg & Emissions using on-site fossil fuel rates from ANSI/RESNET and electricity using Cambium 2024 low renewable cost high natural gas price scenario with long run marginal emissions rate levelized by 3\% over 15 years starting in 2027 \\ \hline
out.emissions.all\_fuels.lrmer\_high\_re\_cost\_low\_ng\_price\_25.co2e\_kg & co2e\_kg & Emissions using on-site fossil fuel rates from ANSI/RESNET and electricity using Cambium 2024 high renewable cost low natural gas price scenario with long run marginal emissions rate levelized by 3\% over 25 years \\ \hline
out.emissions.all\_fuels.lrmer\_high\_re\_cost\_low\_ng\_price\_15.co2e\_kg & co2e\_kg & Emissions using on-site fossil fuel rates from ANSI/RESNET and electricity using Cambium 2024 high renewable cost low natural gas price scenario with long run marginal emissions rate levelized by 3\% over 15 years starting in 2027 \\ \hline
out.emissions.all\_fuels.aer\_high\_re\_cost\_avg.co2e\_kg & co2e\_kg & Emissions using on-site fossil fuel rates from ANSI/RESNET and electricity using Cambium 2024 high renewable cost scenario with average emissions rates averaged from 2025-2050.  \\ \hline
out.emissions.all\_fuels.aer\_high\_re\_cost\_low\_ng\_price\_avg.co2e\_kg & co2e\_kg & Emissions using on-site fossil fuel rates from ANSI/RESNET and electricity using Cambium 2024 high renewable cost low natural gas price scenario with average emissions rates averaged from 2025-2050.  \\ \hline
out.emissions.all\_fuels.aer\_low\_re\_cost\_avg.co2e\_kg & co2e\_kg & Emissions using on-site fossil fuel rates from ANSI/RESNET and electricity using Cambium 2024 low renewable cost scenario with average emissions rates averaged from 2025-2050.  \\ \hline
out.emissions.all\_fuels.aer\_low\_re\_cost\_high\_ng\_price\_avg.co2e\_kg & co2e\_kg & Emissions using on-site fossil fuel rates from ANSI/RESNET and electricity using Cambium 2024 low renewable cost high natural gas price scenario with average emissions rates averaged from 2025-2050.  \\ \hline
out.emissions.all\_fuels.aer\_mid\_case\_avg.co2e\_kg & co2e\_kg & Emissions using on-site fossil fuel rates from ANSI/RESNET and electricity using Cambium 2024 mid case scenario with average emissions rates averaged from 2025-2050.  \\
\end{customLongTable}
...
\endlastfoot
        ...
        out.bills.propane.usd & \$ & Annual total charges for propane \\ \hline
        out.bills.all\_fuels.usd.savings & \$ & Annual total savings for electricity, fuel oil, natural gas, and propane \\ \hline
        out.bills.electricity.usd.savings & \$ & Annual total savings for electricity \\ \hline
        out.bills.fuel\_oil.usd.savings & \$ & Annual total savings for fuel oil \\ \hline
        out.bills.natural\_gas.usd.savings & \$ & Annual total savings for natural gas \\ \hline
        out.bills.propane.usd.savings & \$ & Annual total savings for propane
\end{longtable}
...
The full year electricity bill was then calculated for each modeled dwelling unit using the dwelling unit's modeled electricity consumption, the state average variable electricity rate, and the nationwide static charge.
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{images/natural_gas_census_regions.png}
...
\begin{customLongTable}{ |p{6cm}|p{1.5cm}|p{7.5cm}| }
        ...
        {\textbf{Field Name} & \textbf{Units} & \textbf{Field Description}} 
                out.panel.load.total\_load.<method>.w & W & Total service feeder load calculated per selected NEC method \\ \hline
                out.panel.load.occupied\_capacity.<method>.a & A & Total capacity occupied on the panel, calculated as total load (W) divided by panel voltage (240V) \\ \hline
                out.panel.load.headroom\_capacity.<method>.a & A & Available capacity on the panel, calculated as panel service rating (A) minus total occupied capacity (A) \\ \hline
                out.panel.load.heating.w & W & Sum of space heating system and heat pump heating electric loads. For the load calculation, only the max of heating or cooling is used, not both \\ \hline
                out.panel.load.cooling.w & W & Sum of space cooling system and heat pump cooling electric loads. For the load calculation, only the max of heating or cooling is used, not both \\ \hline
                out.panel.load.hot\_water.w & W & Sum of water heating system electric loads, for electric only \\ \hline
                out.panel.load.clothes\_dryer.w & W & Sum of clothes dryer electric loads, for electric only \\ \hline
                out.panel.load.dishwasher.w & W & Sum of dishwasher electric loads \\ \hline
                out.panel.load.range\_oven.w & W & Sum of range/oven electric loads, for electric only \\ \hline
                out.panel.load.mech\_vent.w & W & Sum of mechanical ventilation electric loads \\ \hline
                out.panel.load.permanent\_spa\_heat.w & W & Sum of permanent spa heater electric load, for electric only \\ \hline
                out.panel.load.permanent\_spa\_pump.w & W & Sum of permanent spa pump electric loads \\ \hline
                out.panel.load.pool\_heater.w & W & Sum of pool heater electric loads \\ \hline
                out.panel.load.pool\_pump.w & W & Sum of pool pump electric loads \\ \hline
                out.panel.load.well\_pump.w & W & Sum of well pump electric loads \\ \hline
                out.panel.load.ev\_charging.w & W & Sum of electric vehicle charging equipment electric loads \\ \hline
                out.panel.load.other.w & W & Sum of other electric loads, including but not limited to lighting/general receptacles at 3 W/sqft, refrigerator, microwave, and garbage disposal \\ \hline
                out.panel.breaker\_space.occupied.count & count & Total number of occupied spaces on the panel \\ \hline
                out.panel.breaker\_space.headroom.count & count & Available spaces, calculated as total rated spaces minus occupied spaces \\ \hline
                out.panel.breaker\_space.heating.count & count & Sum of heating system and heat pump heating occupied spaces \\ \hline
                out.panel.breaker\_space.cooling.count & count & Sum of cooling system and heat pump cooling occupied spaces \\ \hline
                out.panel.breaker\_space.hot\_water.count & count & Sum of water heating system occupied spaces \\ \hline
                out.panel.breaker\_space.clothes\_dryer.count & count & Sum of clothes dryer occupied spaces \\ \hline
                out.panel.breaker\_space.dishwasher.count & count & Sum of dishwasher occupied spaces \\ \hline
                out.panel.breaker\_space.range\_oven.count & count & Sum of range/oven occupied spaces \\ \hline
                out.panel.breaker\_space.mech\_vent.count & count & Sum of mechanical ventilation occupied spaces \\ \hline
                out.panel.breaker\_space.permanent\_spa\_heat.count & count & Sum of permanent spa heater occupied spaces \\ \hline
                out.panel.breaker\_space.permanent\_spa\_pump.count & count & Sum of permanent spa pump occupied spaces \\ \hline
                out.panel.breaker\_space.pool\_heater.count & count & Sum of pool heater occupied spaces \\ \hline
                out.panel.breaker\_space.pool\_pump.count & count & Sum of pool pump occupied spaces \\ \hline
                out.panel.breaker\_space.well\_pump.count & count & Sum of well pump occupied spaces \\ \hline
                out.panel.breaker\_space.ev\_charging.count & count & Sum of electric vehicle charging occupied spaces \\ \hline
                out.panel.breaker\_space.other.count & count & Sum of other electric load occupied spaces \\ \hline
                
                out.panel.constraint.capacity.<method> & bool & Whether electric panel is capacity-constrained per the given method, defined as when out.panel.load.headroom\_capacity.<method>.a < 0 \\ \hline
                out.panel.constraint.breaker\_space & bool & Whether electric panel is space-constrained, defined as when out.panel.breaker\_space.headroom.count < 0 \\ \hline
                out.panel.constraint.overall.<method> & categorical & Summarize overall electric panel constraint per the given method as "no constraint", "space constrained only", "capacity constrained only", or "capacity and space constrained" \\ \hline

                out.panel.load.total\_load.<method>.w.savings & W & For an upgrade measure only, total service feeder load reduced per selected NEC method \\ \hline
                out.panel.load.occupied\_capacity.<method>.a.savings & A & For an upgrade measure only, total occupied capacity reduced per selected NEC method \\ \hline
                out.panel.breaker\_space.occupied.count.savings & count & For an upgrade measure only, total number of occupied spaces reduced \\
\end{customLongTable}
