...
\input{tables/arguments/Water Heater Location}
...
\paragraph{Options}
Water Heater Efficiency options define the technical details of the standalone water heaters and solar thermal water heaters with storage backup, from fuel type to the presence of flue (Table \ref{table:hc_opt_water_heater_efficiency_-_water_heater}). 
...
\input{tables/options/Water Heater Efficiency - water_heater}
...
The options for solar water heaters in ResStock distinguishes by orientation and backup fuel as shown in Table \ref{table:hc_opt_solar_water_heater_eff}. The tilt of the collector is set to roof pitch for all options. The azimuth of the collector varies by option, with East (90\degree), South (180\degree), West (270\degree), and North (0\degree) orientations available.
...
\begin{customLongTable}{|p{3cm}|p{1.85cm}|p{1.85cm}|p{1.5cm}|p{1.95cm}|p{1.95cm}|p{1.5cm}|}{Water Heater Efficiency options and arguments that vary for each option of solar water heaters.}{table:hc_opt_solar_water_heater_eff} 
  {Option name &
  ...
  90 & roofpitch & electricity & 0.97 & 0.98 & 6.2 \\ \hline
  Solar Thermal, 40 sqft, North, Roof Pitch, Electric Standard Backup &
  0 & roofpitch & electricity & 0.97 & 0.98 & 6.2 \\ \hline
  Solar Thermal, 40 sqft, South, Roof Pitch, Electric Standard Backup &
  180 & roofpitch & electricity & 0.97 & 0.98 & 6.2 \\ \hline
  Solar Thermal, 40 sqft, South, Roof Pitch, Fuel Oil Standard Backup &
  180 & roofpitch & fuel oil & 0.62 & 0.78 & 0 \\ \hline
  Solar Thermal, 40 sqft, South, Roof Pitch, Natural Gas Standard Backup &
  180 & roofpitch & natural gas & 0.59 & 0.76 & 0 \\ \hline
  Solar Thermal, 40 sqft, South, Roof Pitch, Propane Standard Backup &
  180 & roofpitch & propane & 0.59 & 0.76 & 0 \\ \hline
  Solar Thermal, 40 sqft, West, Roof Pitch, Electric Standard Backup &
  270 & roofpitch & electricity & 0.97 & 0.98 & 6.2 \\
  \end{customLongTable}

For the full argument definitions, see Table \ref{table:hc_arg_def_water_heater_eff} on storage and tankless water heaters and Table \ref{table:hc_arg_def_solar_hot_water} on solar water heaters. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-water-heating-systems}{Water Heating Systems} and \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-solar-thermal}{Solar Thermal} documentation for the available HPXML schema elements, default values, and constraints.

\input{tables/arguments/Water Heater Efficiency}
...
\input{tables/arguments/Hot Water Distribution}
...
\input{tables/arguments/Hot Water Fixtures}
...
%arguments table
\input{tables/arguments/Refrigerator}
...
%arguments table
\input{tables/arguments/Refrigerator Usage Level}
...
%arguments table
\input{tables/arguments/Misc Extra Refrigerator}
...
%arguments table
\input{tables/arguments/Misc Freezer}
...
%arguments table
\input{tables/arguments/Cooking Range}
...
%arguments table
\input{tables/arguments/Cooking Range Usage Level}
...
%arguments table
\input{tables/arguments/Dishwasher}
...
%arguments table
\input{tables/arguments/Dishwasher Usage Level}
...
%arguments table
\input{tables/arguments/Clothes Washer}
...
%arguments table
\input{tables/arguments/Clothes Washer Usage Level}
...
%arguments table
\input{tables/arguments/Clothes Dryer}
...
%arguments table
\input{tables/arguments/Clothes Dryer Usage Level}
...
%arguments table
\input{tables/arguments/Ceiling Fan}
...
\input{tables/arguments/Misc Pool}
...
The annual energy consumption of the electric pool heater. \\
\hline
...
\input{tables/arguments/Misc Pool Pump}
...
\input{tables/arguments/Misc Hot Tub Spa}
...
\input{tables/arguments/Misc Well Pump}
...
\input{tables/arguments/Misc Gas Fireplace}
...
\input{tables/arguments/Misc Gas Grill}
...
\input{tables/arguments/PV Orientation}
...
\input{tables/arguments/PV System Size}
...
\input{tables/arguments/Battery}
...
\input{tables/arguments/Dehumidifier}
...
\input{tables/arguments/Lighting}
...
\input{tables/arguments/Misc Gas Lighting}
...
\input{tables/arguments/Lighting Interior Use}
...
\input{tables/arguments/Lighting Other Use}
...
\input{tables/arguments/Plug Loads}
...
\input{tables/arguments/Plug Load Diversity}
...
\begin{longtable}[]{ |p{5cm}|p{5.5cm}| } \caption{Electric Vehicle Ownership options and arguments that vary for each option} \label{table:hc_opt_ev_ownership}  \\
  \toprule\noalign{}
...
\input{tables/arguments/Electric Vehicle Battery}
...
\begin{longtable}[]{ |p{3.75cm}|p{2.25cm}|p{2.25cm}|p{2.25cm}|p{2.25cm}|p{2.25cm}|} \caption{Electric Vehicle Battery options and arguments that vary for each option} \label{table:hc_opt_ev_battery}  \\
  \toprule\noalign{}
...
\input{tables/arguments/Electric Vehicle Charge At Home}
...
\input{tables/arguments/Electric Vehicle Charger}
...
\input{tables/arguments/Electric Vehicle Miles Traveled}
...
\input{tables/arguments/Occupants}
...
\input{tables/arguments/Vacancy Status}
