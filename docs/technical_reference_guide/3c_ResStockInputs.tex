...
\subsection{Modeling Approach}
% TODO: High level summary of electric vehicle modeling
% Collaboration with the NREL TEMPO team.
% Ownership, preferences, Battery modeling, charging and discharging.
The electric vehicle capabilities in ResStock were largely created under a joint project to ensure consistency between model outputs for ResStock and Transportation Energy \& Mobility Pathway Options Model (TEMPO).
