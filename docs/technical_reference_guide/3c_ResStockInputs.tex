...
The compressor power rating is estimated based on its design capacity using a regression equation derived from a review of over 200 direct expansion systems. The products reviewed include ducted and non-ducted heat pumps, central AC, and 240V room AC, as a similar trend is observed across them. The regression estimates the Minimum Circuit Amp of the compressor, which is then multiplied by the voltage (240V) to arrive at power. 
...
\begin{customLongTable}{ |p{3cm}|p{4cm}|p{8cm}| }
  ...
  Heat Pump or AC Compressor & (0.631 * Heating\_or\_Cooling\_Capacity [kBtu/h] + 1.615) * 240 & Regression of Minimum Circuit Amp, multiplied by voltage \hline
  Electric Resistance Furnace, Boiler, or Strip Heat & Heating_Capacity [kBtu/h] * 293.07 & Convert heating capacity to power directly at 100\% efficiency \\ \hline
