...
\paragraph{Description}
The efficiency and type of water heater.
...
\item
  ...
  energy consumption.
\item
  The data shows approximately a log-normal distribution. From the data, the average multiplier is 0.8 and the
...
mapped to quantitative percentage as:
...
\begin{itemize}
  ...
  \item The RECS 2020 saturations for each segment in a given PUMA are scaled to match the Experian PUMA weighted averaged battery EV saturation using the segment unit counts from PUMS 2019-5yrs survey.
\end{itemize}
...
The property definitions are shown in Table \ref{table:hc_arg_def_electric_vehicle_battery}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-vehicles}{Vehicles} documentation for additional information.
...
The property definitions are shown in Table \ref{table:hc_arg_def_electric_vehicle_charge_at_home}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-vehicles}{Vehicles} documentation for additional information.
...
The property definitions are shown in Table \ref{table:hc_arg_def_electric_vehicle_charger}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-electric-vehicle-chargers}{Electric Vehicle Charger} documentation for additional information.
...
The property definitions are shown in Table \ref{table:hc_arg_def_electric_vehicle_miles_traveled}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-vehicles}{Vehicles} documentation for additional information.
...
The property definitions are shown in Table \ref{table:hc_arg_def_occupants}.
