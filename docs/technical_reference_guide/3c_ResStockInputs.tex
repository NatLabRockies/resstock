...
The options for solar water heaters in ResStock distinguishes by orientation and backup fuel as shown in Table \ref{table:hc_opt_water_heater_efficiency_-_solar_thermal}. The tilt of the collector is set to roof pitch for all options. The azimuth of the collector varies by option, with East (90\degree), South (180\degree), West (270\degree), and North (0\degree) orientations available.
...
\input{tables/options/Water Heater Efficiency - solar_thermal}
...
\input{tables/arguments/Misc Pool Heater}
