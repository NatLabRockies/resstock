...
\paragraph{Options}
Water Heater Efficiency options define the technical details of the standalone water heaters and solar thermal water heaters with storage backup, from fuel type to the presence of flue (Table \ref{table:hc_opt_water_heater_eff}). 
...
For heat pump water heaters the \texttt{water\_heater\_efficiency\_type} UniformEnergyFactor is used; EnergyFactor is currently used for all other water heaters.

\begin{customLongTable}{|p{3cm}|p{2.25cm}|p{2cm}|p{1.75cm}|p{2.5cm}|p{2.25cm}|}{Water Heater Efficiency options and arguments that vary for each option of storage and tankless water heaters.} {table:hc_opt_water_heater_eff} 
{Option name &
...
Other Fuel & storage water heater & coal & auto & 0.59 & 0.76 \\
...
Wood & storage water heater & wood & auto & 0.59 & 0.76 \\
\end{customLongTable}
...
Nominal volume of water heater tank. If not provided, the OS-HPXML default (see \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#conventional-storage}{Conventional Storage}, \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#heat-pump}{Heat Pump} is used.) \\
\hline
\texttt{water\_backup\_heaing\_efficiency} & false & Btu/hr & Double &
auto & Backup heating capacity for a heat pump water heater. If not provided, the OS-HPXML default (see \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#heat-pump}{Heat Pump}.)\\
\hline
...
auto & Heating capacity. Only applies to storage water heater and heat pump water heater (compressor). If not provided, the OS-HPXML default (see \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#conventional-storage}{Conventional Storage}, \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#heat-pump}{Heat Pump} is used.) \\
\hline
...
For retrofit upgrades, other options are available and can be defined using the following arguments. For the argument definitions, see Table \ref{table:hc_arg_def_hot_water_dist}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-hot-water-distribution}{Hot Water Distribution} documentation for the available HPXML schema elements, default values, and constraints.
...
\href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html\#recirculation-in-unit}{Recirculation
(In-Unit)}) is used. \\
\hline
...
For the argument definitions, see Table \ref{table:hc_arg_def_hot_water_fix}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-water-fixtures}{Water Fixtures} documentation for the available HPXML schema elements, default values, and constraints.
...
\href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html\#hpxml-refrigerators}{HPXML
...
\paragraph{Options}
Extra refrigerators are specified using the same Energy Factor (EF) and annual rated kWh options as primary refrigerators.  The characteristic set the \texttt{extra\_refrigerator\_present}, \texttt{extra\_refrigerator\_location}, \texttt{extra\_refrigerator\_rated\_annual\_kwh}, and \texttt{extra\_refrigerator\_usage\_multiplier} ResStock arguments (Table \ref{table:hc_opt_extra_ref}). 
If an extra refrigerator is present, the location is always set to auto. 
The usage multiplier varies by state and is set to account for the presence of teriary refrigerators and beyond, see \ref{table:hc_opt_extra_ref_usage_mult}.
...
\begin{longtable}[]{ |p{1.cm}|p{5cm}| }
  \caption{Misc Extra Refrigerator usage multiplier varies by state.} \label{table:hc_opt_extra_ref_usage_mult} \\
  \toprule\noalign{}
  State  & \texttt{extra\_refrigerator\_usage\_multiplier} \\
  \midrule\noalign{}
  \endhead
  \bottomrule\noalign{}
  \endlastfoot
...
The usage multiplier varies by state and is set to account for the presence of extra freezers, see \ref{table:hc_opt_freezer_usage_mult}.
...
\bottomrule\noalign{}
\endlastfoot
EF 12, National Average & true & auto & 935 \\
None & false & auto & 0 \\
\end{longtable}

\begin{longtable}[]{ |p{1.cm}|p{5cm}| }
  \caption{Misc Freezer usage multiplier varies by state.} \label{table:hc_opt_freezer_usage_mult} \\
  \toprule\noalign{}
  State  & \texttt{freezer\_usage\_multiplier} \\
  \midrule\noalign{}
  \endhead
  \bottomrule\noalign{}
  \endlastfoot
...
For the argument definitions, see Table \ref{table:hc_arg_def_clothes washer}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-clothes-washer}{Clothes Washer} documentation for the available HPXML schema elements, default values, and constraints.
...
not provided, the OS-HPXML default (see
\href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html\#hpxml-clothes-washer}{HPXML
...
For the argument definitions, see Table \ref{table:hc_arg_def_ceiling_fans}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-ceiling-fans}{Ceiling Fans} documentation for the available HPXML schema elements, default values, and constraints.
...
\href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html\#hpxml-ceiling-fans}{HPXML
...
For the argument definitions, see Table \ref{table:hc_arg_def_pool}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-pools}{Pools} documentation for the available HPXML schema elements, default values, and constraints.
...
For the argument definitions, see Table \ref{table:hc_arg_def_pool_heat}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#pool-heater}{Pool Heater} documentation for the available HPXML schema elements, default values, and constraints.
...
For the argument definitions, see Table \ref{table:hc_arg_def_pool_pump}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#pool-pump}{ Pool Pump} documentation for the available HPXML schema elements, default values, and constraints.
...
For the argument definitions, see Table \ref{table:hc_arg_def_hot_tub}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-permanent-spas}{Permanent Spas} documentation for the available HPXML schema elements, default values, and constraints.
...
provided, the OS-HPXML default (see
\href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html\#permanent-spa-pump}{Permanent
Spa Pump}) is used. \\
\hline
...
For the argument definitions, see Table \ref{table:hc_arg_def_well_pump}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-misc-loads}{Misc Loads} documentation for the available HPXML schema elements, default values, and constraints.
...
For the argument definitions, see Table \ref{table:hc_arg_def_gas_fireplace}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hvac-heating-fireplaces}{Fireplace} documentation for the available HPXML schema elements, default values, and constraints.
...
provided, the OS-HPXML default (see
\href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html\#hpxml-fuel-loads}{HPXML
Fuel Loads}) is used. \\
\hline
...
For the argument definitions, see Table \ref{table:hc_arg_def_gas_grill}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-fuel-loads}{Fuel Loads} documentation for the available HPXML schema elements, default values, and constraints.
...
For the argument definitions, see Table \ref{table:hc_arg_def_pv_orient}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-photovoltaics}{Photovoltaics} documentation for the available HPXML schema elements, default values, and constraints.
...
For the argument definitions, see Table \ref{table:hc_arg_def_pv_size}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-photovoltaics}{Photovoltaics} documentation for the available HPXML schema elements, default values, and constraints.
...
For the argument definitions, see Table \ref{table:hc_arg_def_misc_gas_light}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-fuel-loads}{Misc Fuel Loads} documentation for the available HPXML schema elements, default values, and constraints.
...
For the argument definitions, see Table \ref{table:hc_arg_def_light_oth_use}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-lighting}{Lighting} documentation for the available HPXML schema elements, default values, and constraints. 
...
For the argument definitions, see Table \ref{table:hc_arg_def_plug_load}. See the OpenStudio-HPXML \href{https://openstudio-hpxml.readthedocs.io/en/v1.10.0/workflow_inputs.html#hpxml-plug-loads}{Plug Loads} documentation for the available HPXML schema elements, default values, and constraints.
...
The options and their ResStock arguments values can be found in Table \ref{table:hc_opt_ev_vmt}. The options range between 1,000 miles and 22,500 miles.
