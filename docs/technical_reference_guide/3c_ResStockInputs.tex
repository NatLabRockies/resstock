...
The options for solar water heaters in ResStock are a combination of orientation and backup fuel, Table \ref{table:hc_opt_water_heater_efficiency_-_solar_thermal}. 
