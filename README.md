...
Software for running ResStock simulations:
 ...
 - For large-scale production runs of ResStock, it is recommended that [buildstockbatch](https://github.com/NREL/buildstockbatch) is used. For smaller-scale tests, [run_analysis.rb](https://github.com/NREL/resstock/blob/develop/workflow/run_analysis.rb) can be used. Information about the workflow can be found in ResStock's [documentation](https://resstock.readthedocs.io/en/latest/basic_tutorial/running_a_project.html#using-run-analysis-rb).
