In the YML file's "elec_folder" field for emissions scenario definitions, enter a relative file path to a folder (e.g., "data/emissions/cambium/2024/LRMER_MidCase_15") containing schedule files with hourly electricity emissions factor values.
