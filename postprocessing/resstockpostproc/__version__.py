...
__description__ = "Postprocessing for ResStock, compares model results to other data sources and creates graphics"
__url__ = "https://github.com/NREL/resstock/postprocessing"
