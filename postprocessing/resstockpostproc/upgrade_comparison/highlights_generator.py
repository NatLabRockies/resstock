...
from resstockpostproc.upgrade_comparison.all_plots_generator import get_plotting_function
...
from resstockpostproc.upgrade_comparison.utils import load_highlight_config, load_workflow_config
from resstockpostproc.upgrade_comparison.schema.plot_spec import PlotSpec
from resstockpostproc.upgrade_comparison.schema.workflow_schema import (
    AggregationType,
    BuildingInclusion,
    QuantityGroup,
    QuantityType,
