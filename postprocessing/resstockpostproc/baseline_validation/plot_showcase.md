...
<img src="example_plots/eia_electricity_state_tilemap.svg" alt="EIA electricity by state" width="900">
...
<img src="example_plots/eia_dwelling_units_by_state.svg" alt="EIA dwelling units by state" width="900">
...
<img src="example_plots/eia_electricity_ustotal_annual.svg" alt="EIA electricity U.S. Total annual" width="400">
...
<img src="example_plots/eia_monthly_electricity_ustotal.svg" alt="EIA monthly electricity per unit" width="400">
...
<img src="example_plots/eia_monthly_alaska_drill.svg" alt="EIA Alaska monthly" width="400">

Clicking a single state in the sidebar (Alaska here) produces a focused view with per-month bars and the same 95% CI bands.

### Two-column layout

<img src="example_plots/eia_natural_gas_by_state_two_column.svg" alt="EIA natural gas by state two-column" width="900">
...
<img src="example_plots/eia_electricity_perunit_difference_ustotal.svg" alt="EIA electricity per-unit difference" width="400">
...
<img src="example_plots/recs_enduse_perunit_grouped_ustotal.svg" alt="RECS end-use grouped per unit" width="900">
...
<img src="example_plots/recs_enduse_grouped_ustotal.svg" alt="RECS end-use stacked" width="900">
...
<img src="example_plots/recs_naturalgas_perconsumer_ustotal.svg" alt="RECS natural gas per consumer" width="400">
...
<img src="example_plots/recs_space_heating_naturalgas_ustotal.svg" alt="RECS space heating annual" width="400">
...
<img src="example_plots/recs_monthly_electricity_ustotal.svg" alt="RECS monthly electricity" width="400">
...
<img src="example_plots/recs_naturalgas_penetration_ustotal.svg" alt="RECS natural gas penetration" width="400">
...
<img src="example_plots/recs_enduse_penetration_grouped.svg" alt="RECS end-use penetration grouped" width="900">
...
<img src="example_plots/recs_electricity_by_state_two_column.svg" alt="RECS by state two-column" width="900">

50 states sorted by magnitude (two-column layout). The RECS family also supports the full tilemap layout.

### By building type

<img src="example_plots/recs_electricity_by_building_type.svg" alt="RECS by building type" width="900">

Mobile home, single-family detached, single-family attached, multi-family variants.

### By climate zone

<img src="example_plots/recs_space_heating_by_climate_zone.svg" alt="RECS by climate zone" width="900">
...
<img src="example_plots/recs_electricity_by_census_division.svg" alt="RECS by census division" width="900">
...
<img src="example_plots/recs_electricity_by_vintage.svg" alt="RECS by vintage" width="900">

Pre-1950 through 2010s+. Useful for catching envelope-age and equipment-stock effects.

### By heating fuel

<img src="example_plots/recs_naturalgas_by_heating_fuel.svg" alt="RECS by heating fuel" width="900">

Slice by each home's primary heating fuel. Natural-gas-heated homes vs electric-heated homes vs fuel-oil-heated homes, etc.

### State drill-down

<img src="example_plots/recs_enduse_alaska.svg" alt="RECS Alaska end uses" width="900">
...
<img src="example_plots/recs_distribution_electricity.svg" alt="RECS distribution box plot" width="400">
...
<img src="example_plots/recs_distribution_space_heating.svg" alt="RECS distribution space heating" width="400">
...
<img src="example_plots/recs_distribution_electricity_by_building_type.svg" alt="RECS distribution by building type" width="900">
...
<img src="example_plots/recs_distribution_electricity_histogram.svg" alt="RECS histogram U.S. Total" width="400">
...
<img src="example_plots/recs_histogram_by_building_type.svg" alt="RECS histogram by building type" width="700">
...
<img src="example_plots/recs_histogram_by_vintage.svg" alt="RECS histogram by vintage" width="700">
...
<img src="example_plots/recs_histogram_naturalgas_by_heating_fuel.svg" alt="RECS histogram natural gas by heating fuel" width="700">
...
<img src="example_plots/recs_electricity_ustotal_difference.svg" alt="RECS U.S. Total difference" width="400">

Signed % difference from RECS 2020 for each ResStock release.

### State-level difference

<img src="example_plots/recs_electricity_by_state_difference.svg" alt="RECS state difference" width="900">
...
<img src="example_plots/lrd_load_duration_curve.svg" alt="Load duration curve" width="900">
...
<img src="example_plots/lrd_load_vs_temperature.svg" alt="Load vs outdoor drybulb temperature" width="900">
...
<img src="example_plots/lrd_summer_day_hourly.svg" alt="Average summer day hourly" width="900">
...
<img src="example_plots/lrd_monthly_by_utility.svg" alt="Monthly by utility" width="900">
...
<img src="example_plots/lrd_hourly_matrix_comed.svg" alt="ComEd hourly load matrix" width="700">
