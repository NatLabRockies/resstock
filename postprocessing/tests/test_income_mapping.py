...
def test_income_mapping():
    test_df = pl.DataFrame({
        ...
        "in.geometry_building_type_recs": ["Mobile Home", "NA", "Single Family Detached", "Multi-Family with 2 - 4 Units"],
        "in.county_and_puma": ["G0100030, G01002600", "NA", "G5501390, G55001501", "G3600750, G36000600"],
    ...
    assert assign_representative_income(test_df, return_map_only=True).columns == ["bldg_id", "in.representative_income"], "unexpected cols"
